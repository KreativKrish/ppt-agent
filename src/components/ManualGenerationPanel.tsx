...
import { Input, ParamGroup, Select, TextArea } from "./ParamGroup";
import { Loader2 } from "lucide-react";

export default function ManualGenerationPanel() {
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="mt-8 bg-gray-900 rounded-lg shadow-lg overflow-hidden border border-gray-700">
                <div className="bg-gray-800 px-4 py-2 border-b border-gray-700 flex justify-between items-center">
                    ...
                    <button type="button" onClick={() => setLogs([])} className="text-xs text-gray-400 hover:text-white">Clear</button>
                </div>
